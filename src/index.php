            ...
            <section>
                <div class="item-type swiper">
                    <h1 class="item-branch">
                        <a href="./mainBookShow.php?titleShow=<?php echo 'Trending Book';?> ">
            ...
            <section>
                ...
                <div class="featuredEbook">
                    <div class="leftFeatured">
                        <div class="title">
                            <a href="./mainBookShow.php?titleShow=<?php echo 'Featured Book';?>">
                    ...
                    <div class="rightFeatured">
                        <div class="title-rightFea"> 
                            <a href="./mainBookShow.php?titleShow=<?php echo 'Great Book List';?>">
                        ...
                        <div class="right-feature-main">
                            ...
                            <div class="item-right-feature" data-aos="zoom-in-left">
                                <a href="./mainBookShow.php?titleShow=<?php echo 'Technology Book';?>">
            ...
            <section>
                ...
                <div class="lastestArrivals" data-aos="fade-up" data-aos-duration="1200">
                    <div class="title section-title-lastestArr">
                        <a href="./mainBookShow.php?titleShow=<?php echo "Lastest Arrivals";?>">
